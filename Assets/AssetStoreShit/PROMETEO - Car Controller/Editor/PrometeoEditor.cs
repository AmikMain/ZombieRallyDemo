...
public class PrometeoEditor : Editor
{
    ...
    private SerializedProperty surfaceDriftMultiplier; // <- новое поле
    ...
    private void OnEnable()
    {
        ...
        surfaceDriftMultiplier = SO.FindProperty("surfaceDriftMultiplier"); // <- инициализация
    ...
    public override void OnInspectorGUI()
    {
        ...
        // Новое поле с Range
        surfaceDriftMultiplier.floatValue = EditorGUILayout.Slider("Surface Drift Multiplier:", surfaceDriftMultiplier.floatValue, 0.3f, 10f);
